...
# installed.
TCL_PREFIX='/opt/TopPatch'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/opt/TopPatch'
...
TCL_EXTRA_CFLAGS=' -pipe -fvisibility=hidden -m64 -I/opt/TopPatch/include'
...
TCL_LD_FLAGS='-L/opt/TopPatch/lib -Wl,--export-dynamic '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/opt/TopPatch/tcl8.6.0/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/opt/TopPatch/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/opt/TopPatch/include'
...
# compiled.
TCL_SRC_DIR='/opt/TopPatch/tcl8.6.0'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/opt/TopPatch/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/opt/TopPatch/tcl8.6.0/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/opt/TopPatch/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/opt/TopPatch/tcl8.6.0/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/opt/TopPatch/lib/libtclstub8.6.a'
