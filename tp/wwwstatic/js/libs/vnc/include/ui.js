...
start: function(callback) {
    ...
    UI.initSetting('hostname', window.location.hostname);
    ...
    UI.initSetting('path', '/ra/websockify');
    ...
    Util.addEvent(document.getElementById('connectForm'), 'submit', function (event) {
...
updateState: function(rfb, state, oldstate, msg) {
    ...
    if (typeof(msg) !== 'undefined' && (state === 'password' || state === 'failed')) {
...
connect: function() {
    var host, port, hostname, password, path;
    ...
    hostname= $D('noVNC_hostname').value;
    ...
    UI.rfb.connect(host, port, password, path, hostname);
