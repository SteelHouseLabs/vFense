...
RDBVal = (function(_super) {
  ...
  RDBVal.prototype.indexCreate = varar(1, 3, function(name, defun_or_opts, opts) {
    if (opts != null) {
      ...
      if ((defun_or_opts instanceof Object) && !(defun_or_opts instanceof Function) && !(defun_or_opts instanceof TermBase)) {
...
},{"./errors":8,"./util":7}],14:[function(require,module,exports){
