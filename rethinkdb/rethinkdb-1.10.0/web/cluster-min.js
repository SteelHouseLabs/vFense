...
module('DataExplorerView', function() {
  this.Container = (function(_super) {
    ...
    Container.prototype.toggle_options = function() {
      var that;
      that = this;
      this.deactivate_overflow();
      if (this.history_view.state === 'visible') {
    ...
    Container.prototype.set_doc_description = function(command, tag, suggestions) {
      var full_tag, pair, parent_value, parent_values, parents, return_values, returns, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      if (command['langs']['js']['body'] != null) {
        ...
        this.descriptions[full_tag] = {
          ...
          args: (_ref = /.*(\(.*\))$/.exec(command['langs']['js']['body'])) != null ? _ref[1].replace('$ARG', 'parentType') : void 0,
          description: this.description_with_example_template({
            description: command['description'],
            examples: ((_ref1 = command['langs']['js']['examples']) != null ? _ref1.length : void 0) > 1 ? command['langs']['js']['examples'].slice(0, 1) : command['langs']['js']['examples']
          })
        };
      }
      parents = {};
    ...
    Container.prototype.set_docs = function(data) {
      var command, group, relations, state, tag, _i, _j, _len, _len1, _ref, _ref1;
      _ref = data['sections'];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        group = _ref[_i];
    ...
    Container.prototype.save_query = function(args) {
      ...
      query = query.replace(/\s*$/, '');
      if (window.localStorage != null) {
        if (this.history.length === 0 || this.history[this.history.length - 1].query !== query && this.regex.white.test(query) === false) {
          this.history.push({
            query: query,
            broken_query: broken_query
          });
          if (this.history.length > this.size_history) {
            window.localStorage.rethinkdb_history = JSON.stringify(this.history.slice(this.history.length - this.size_history));
          } else {
    ...
    Container.prototype.clear_history = function() {
      ...
      return window.localStorage.rethinkdb_history = JSON.stringify(this.history);
    };
    ...
    Container.prototype.initialize = function(args) {
      ...
      if (!(DataExplorerView.Container.prototype.saved_data != null)) {
      ...
      if (!(DataExplorerView.Container.prototype.history != null)) {
      ...
      this.history = DataExplorerView.Container.prototype.history;
      this.prototype = DataExplorerView.Container.prototype;
      this.saved_data = DataExplorerView.Container.prototype.saved_data;
      this.show_query_warning = this.saved_data.query !== this.saved_data.current_query;
      this.current_results = this.saved_data.results;
      ...
      this.results_view = new DataExplorerView.ResultView({
        container: this,
        limit: this.limit,
        view: this.saved_data.view
      });
      this.options_view = new DataExplorerView.OptionsView({
        container: this,
        options: this.saved_data.options
      });
    ...
    Container.prototype.render = function() {
      ...
      if ((((_ref = this.saved_data) != null ? _ref.query : void 0) != null) && (((_ref1 = this.saved_data) != null ? _ref1.results : void 0) != null) && (((_ref2 = this.saved_data) != null ? _ref2.metadata : void 0) != null)) {
        this.$('.results_container').html(this.results_view.render_result({
          show_query_warning: this.show_query_warning,
          results: this.saved_data.results,
          metadata: this.saved_data.metadata
        }).$el);
      } else {
    ...
    Container.prototype.init_after_dom_rendered = function() {
      ...
      if (this.saved_data.current_query != null) {
        this.codemirror.setValue(this.saved_data.current_query);
      }
      this.codemirror.focus();
      this.prototype.focus_on_codemirror = true;
      ...
      if (this.saved_data.history_state === 'visible') {
    ...
    Container.prototype.on_blur = function() {
      this.prototype.focus_on_codemirror = false;
    ...
    Container.prototype.handle_keypress = function(editor, event) {
      ...
      this.saved_data.current_query = this.codemirror.getValue();
      if ((event != null ? event.which : void 0) != null) {
              ...
              if ((this.extra_suggestions != null) && this.extra_suggestions.length > 0 && this.extra_suggestion.start_body === this.extra_suggestion.start_body) {
                ...
                if (this.extra_suggestions.length > 0) {
                  ...
                  if (this.current_highlighted_extra_suggestion === -1) {
                    ...
                    if (this.options.electric_punctuation === false) {
                      move_outside = true;
                    }
                    if (/^\s*'/.test(this.current_extra_suggestion) === true) {
                      string_delimiter = "'";
        ...
        if (event.which === 13 && (event.shiftKey || event.ctrlKey || event.metaKey)) {
          ...
          if (this.history_displayed_id < this.history.length) {
            this.history_displayed_id++;
            this.codemirror.setValue(this.history[this.history.length - this.history_displayed_id].query);
            event.preventDefault();
            return true;
          }
      ...
      if (this.options.electric_punctuation === true) {
      ...
      if (((_ref13 = result.suggestions) != null ? _ref13.length : void 0) > 0) {
        ...
        if (this.options.suggestions === true) {
          this.show_suggestion();
        } else {
          this.hide_suggestion();
        }
        ...
        this.hide_suggestion();
        this.description = result.description;
        if (this.options.suggestions === true && (event != null ? event.type : void 0) !== 'mouseup') {
          this.show_description();
        } else {
          this.hide_description();
        }
    ...
    Container.prototype.extend_description = function(fn) {
      var data, database_used, databases_available, description, namespace, namespaces_available, _i, _len, _ref, _ref1, _ref2;
    ...
    Container.prototype.show_more_results = function(event) {
      ...
      try {
        ...
        this.saved_data.cursor.next(get_result_callback);
    ...
    Container.prototype.execute_query = function() {
      var error;
      this.saved_data.cursor_timed_out = false;
      this.saved_data.show_query_warning = false;
      this.driver_handler.postpone_reconnection();
      ...
      try {
        ...
        if (this.queries.length === 0) {
          ...
          return this.results_view.render_error(null, error);
        } else {
    ...
    Container.prototype.execute_portion = function() {
      ...
      while (this.queries[this.index] != null) {
        ...
        try {
          ...
          this.$('.loading_query_img').hide();
          this.results_view.render_error(this.raw_queries[this.index], err);
          this.save_query({
            query: this.raw_query,
            broken_query: true
          });
        ...
        if (rdb_query instanceof this.TermBaseConstructor) {
          ...
          if (this.index === this.queries.length) {
            ...
            this.results_view.render_error(this.raw_queries[this.index - 1], error);
            this.save_query({
              query: this.raw_query,
              broken_query: true
            });
    ...
    Container.prototype.generate_rdb_global_callback = function(id_execution) {
      var rdb_global_callback,
        _this = this;
      rdb_global_callback = function(error, cursor) {
        var get_result_callback, _ref;
        if (_this.id_execution === id_execution) {
          ...
          if (_this.index === _this.queries.length) {
            if (cursor != null) {
              _this.saved_data.cursor = _this.cursor;
            }
            if ((cursor != null ? cursor.hasNext : void 0) != null) {
              ...
              _this.saved_data.query = _this.query;
              _this.saved_data.results = _this.current_results;
              _this.saved_data.metadata = {
              ...
              _this.results_view.render_result({
                ...
                metadata: _this.saved_data.metadata
              });
  ...
  this.ResultView = (function(_super) {
    ...
    ResultView.prototype.initialize = function(args) {
      ...
      this.last_keys = this.container.saved_data.last_keys;
      return this.last_columns_size = this.container.saved_data.last_columns_size;
    };
    ...
    ResultView.prototype.show_tree = function(event) {
      event.preventDefault();
      return this.set_view('tree');
    };

    ResultView.prototype.show_table = function(event) {
      event.preventDefault();
      return this.set_view('table');
    };

    ResultView.prototype.show_raw = function(event) {
      event.preventDefault();
    ...
    ResultView.prototype.set_view = function(view) {
      this.view = view;
      this.container.saved_data.view = view;
    ...
    */
    ...
    ResultView.prototype.build_map_keys = function(args) {
    ...
    ResultView.prototype.compute_occurrence = function(keys_count) {
    ...
    ResultView.prototype.order_keys = function(keys) {
    ...
    ResultView.prototype.json_to_table = function(result) {
      ...
      this.container.saved_data.last_keys = this.last_keys;
    ...
    ResultView.prototype.get_all_attr = function(args) {
    ...
    ResultView.prototype.json_to_table_get_attr = function(flatten_attr) {
      return this.template_json_table.tr_attr({
        attr: flatten_attr
      });
    };

    ResultView.prototype.json_to_table_get_values = function(args) {
      ...
      for (i = _i = 0, _len = result.length; _i < _len; i = ++_i) {
        ...
        new_document.record = this.container.saved_data.start_record + i;
    ...
    ResultView.prototype.date_to_string = function(date) {
    ...
    ResultView.prototype.handle_mousemove = function(event) {
      if (this.mouse_down) {
        this.last_columns_size[this.col_resizing] = Math.max(5, this.start_width - this.start_x + event.pageX);
        return this.resize_column(this.col_resizing, this.last_columns_size[this.col_resizing]);
      }
    };

    ResultView.prototype.resize_column = function(col, size) {
    ...
    ResultView.prototype.default_size_column = 310;

    ResultView.prototype.render_result = function(args) {
      var col, column, current_size, expandable_columns, extra_size_table, index, keys, max_size, minutes, num_results, previous_keys, real_size, same_keys, value, _i, _j, _k, _len, _len1, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
      ...
      if ((args != null ? (_ref = args.metadata) != null ? _ref.skip_value : void 0 : void 0) != null) {
        this.container.saved_data.start_record = args.metadata.skip_value;
        if (args.metadata.execution_time != null) {
          if (args.metadata.execution_time < 1000) {
            this.metadata.execution_time_pretty = args.metadata.execution_time + "ms";
          } else if (args.metadata.execution_time < 60 * 1000) {
            this.metadata.execution_time_pretty = (args.metadata.execution_time / 1000).toFixed(2) + "s";
          } else {
            minutes = Math.floor(args.metadata.execution_time / (60 * 1000));
            this.metadata.execution_time_pretty = minutes + "min " + ((args.metadata.execution_time - minutes * 60 * 1000) / 1000).toFixed(2) + "s";
          }
        }
      }
      num_results = this.metadata.skip_value;
      if (this.metadata.has_more_data !== true) {
        if (((_ref1 = this.results) != null ? _ref1.length : void 0) != null) {
      ...
      this.$el.html(this.template(_.extend(this.metadata, {
        ...
        show_more_data: this.metadata.has_more_data === true && this.container.saved_data.cursor_timed_out === false,
        cursor_timed_out_template: (this.metadata.has_more_data === true && this.container.saved_data.cursor_timed_out === true ? this.cursor_timed_out_template() : void 0),
        execution_time_pretty: this.metadata.execution_time_pretty,
        no_results: this.metadata.has_more_data !== true && ((_ref2 = this.results) != null ? _ref2.length : void 0) === 0 && this.metadata.skip_value === 0,
      ...
      switch (this.view) {
        ...
        case 'table':
          ...
          if (this.last_keys.length !== previous_keys.length) {
            same_keys = false;
          } else {
            same_keys = true;
            _ref3 = this.last_keys;
            for (index = _i = 0, _len = _ref3.length; _i < _len; index = ++_i) {
              keys = _ref3[index];
              if (this.last_keys[index] !== previous_keys[index]) {
                same_keys = false;
              }
            }
          }
          if (same_keys === true) {
            _ref4 = this.last_columns_size;
            for (col in _ref4) {
              value = _ref4[col];
          ...
          if (extra_size_table > 0) {
            expandable_columns = [];
            for (index = _j = 0, _ref5 = this.last_keys.length - 1; 0 <= _ref5 ? _j <= _ref5 : _j >= _ref5; index = 0 <= _ref5 ? ++_j : --_j) {
              real_size = 0;
    ...
    ResultView.prototype.set_scrollbar = function() {
    ...
    ResultView.prototype.cursor_timed_out = function() {
      var _ref;
      this.container.saved_data.cursor_timed_out = true;
      if (((_ref = this.container.saved_data.metadata) != null ? _ref.has_more_data : void 0) === true) {
  ...
  this.OptionsView = (function(_super) {
    ...
    function OptionsView() {
      ...
      this.toggle_view = __bind(this.toggle_view, this);

      this.toggle_suggestions = __bind(this.toggle_suggestions, this);
    ...
    OptionsView.prototype.toggle_option = function(event) {
      ...
      if (event.target.nodeName !== 'INPUT') {
        ...
        if (window.localStorage != null) {
          return window.localStorage.options = JSON.stringify(this.options);
        }
      }
    };

    OptionsView.prototype.toggle_suggestions = function() {
      this.options.suggestions = !this.options.suggestions;
      if (this.$('.content').css('display') === 'block') {
        return this.$('#suggestions').prop('checked', this.options.suggestions);
      }
    };

    OptionsView.prototype.toggle_view = function() {
      var that;
      that = this;
      if (this.state === 'visible') {
        this.state = 'hidden';
        return this.$('.content').slideUp('fast', function() {
          if (that.state === 'hidden') {
            that.$('.nano_border').hide();
            return that.$('.arrow_options').hide();
          }
        });
      } else {
        this.state = 'visible';
        this.$('.arrow_options').show();
        this.$('.nano_border').show();
        return this.$('.content').slideDown('fast');
      }
    };
  ...
  this.HistoryView = (function(_super) {
    ...
    HistoryView.prototype.load_query = function(event) {
      ...
      return this.container.saved_data.current_query = this.history[parseInt(id)].query;
    };
  ...
  return this.DriverHandler = (function() {
    ...
    function DriverHandler(args) {
      ...
      this.postpone_reconnection = __bind(this.postpone_reconnection, this);
      ...
      this.dont_timeout_connection = args.dont_timeout_connection != null ? args.dont_timeout_connection : false;
    ...
    DriverHandler.prototype.connect = function() {
      ...
      try {
        r.connect(this.server, function(err, connection) {
          if (err != null) {
            return that.on_fail(err);
          } else {
            that.connection = connection;
            that.on_success(connection);
            connection.removeAllListeners('error');
            return connection.on('error', that.on_fail);
          }
        });
        if (this.container != null) {
          this.container.results_view.cursor_timed_out();
        }
        if (!this.dont_timeout_connection) {
    ...
    DriverHandler.prototype.postpone_reconnection = function() {
      clearTimeout(this.timeout);
      return this.timeout = setTimeout(this.connect, 5 * 60 * 1000);
    };
  ...
  this.Container = (function(_super) {
    ...
    Container.prototype.render_header = function() {
      ...
      return this.$('.header').html(this.header_template({
        ...
        from_date: new XDate(((_ref = this.current_logs[0]) != null ? _ref.get('timestamp') : void 0) * 1000).toString("MMMM M, yyyy 'at' HH:mm:ss"),
        to_date: new XDate(((_ref1 = this.current_logs[this.displayed_logs - 1]) != null ? _ref1.get('timestamp') : void 0) * 1000).toString("MMMM M, yyyy 'at' HH:mm:ss"),
        logs_for: {
